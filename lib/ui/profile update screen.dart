  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child:Consumer<UserManagement>(builder: (context, provider, child) {
                ...
                if(index  == 0)
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.only(left: 15.0, right: 15.0),
                        child: TextFormField(
                          controller: TextEditingController()..text = userPreferences!.getString("email")??"",
                  ...
                  child: Column(
                    ...
                    child: CupertinoButton(
                        ...
                        child: Text("Update"),
                        onPressed: () {
                          provider.updateProfileSettings(userPreferences!.getString("sessionKey")??"", nameController.text).then((value) {
                             print("Your info updated successfully!");
